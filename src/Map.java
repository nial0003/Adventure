public class Map {
    ...
    public Room createMap() {
        ...
        Room room1 = new Room("The Clearing",
                "You've just entered into the magical forest and has arrived at a clearing. \n" +
                "You're standing beneath an open canopy and can see the sky. By your estimation it's mid-day. The entrance from which you came \n" +
                "has been sealed shut by the very trees themselves as if they were alive and trying to prevent your escape. In the middle of the clearing \n" +
                "is a picnic cloth and a basket. Inside the basket is a single apple and a shiny brass oil lamp sits next to the basket. \n" +
        ...
        Room room4 = new Room("The Musky Swamp", "As you come closer a musky scent reaches your nostrils. You finally break out from the corridor\n" +
        ...
        Room room5 = new Room("Elven city", "As you move away from the frozen forest you start to thaw and feel warmer. You're following the\n" +
        ...
        Room room6 = new Room("The Sphinx's Challenge", "As you step into this eerie chamber, the air feels heavy with an ancient, mystical presence.\n" +
        ...
        Room room7 = new Room("The Hungry Garden", "You tread carefully as you enter this unsettling section of the forest.\n" +
        ...
        Room room8 = new Room("The Frozen Sanctuary", "The once enchanting melody of the elves has become louder, almost overwhelming,\n" +
                ...
                "You've entered a magically frozen part of the forest. The cold is unbearable, and there are two ways out, but you must move quickly\n" +
                        "to avoid freezing.");
        Room room9 = new Room("The Fiery Abyss", "The heat strikes you like a hammer as soon as you step into this chamber. The air here\n" +
        ...
        room1.addItem(new MeleeWeapon("Rapier", "A sharp pointy rapier", 2));

        room1.addItem(new MeleeWeapon("Sword", "A sharp sword.", 2));
